<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight dark:text-paper-100">Nuevo cambio de disponibilidad</h2>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('planta.disponibilidad.store') }}"
                ...
                @csrf
                @include('planta.disponibilidad._form')
            ...
            <p class="mt-3 text-xs text-gray-500 dark:text-paper-400">
                Guardar crea un BORRADOR: todavía no mueve saldo. El inventario cambia al confirmar.
            </p>
        </div>
    </div>
</x-app-layout>
