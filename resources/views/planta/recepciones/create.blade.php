<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight dark:text-paper-100">Nueva recepción de insumos</h2>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('planta.recepciones.store') }}"
                ...
                @csrf
                @include('planta.recepciones._form')
            ...
            <p class="mt-3 text-xs text-gray-500 dark:text-paper-400">
                Guardar crea un BORRADOR: todavía no mueve inventario. El saldo cambia al confirmar.
            </p>
        </div>
    </div>
</x-app-layout>
