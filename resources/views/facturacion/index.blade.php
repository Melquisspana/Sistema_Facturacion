    ...
    <x-slot name="header">
        <div class="flex flex-wrap items-center justify-between gap-2">
            ...
            {{-- Acción secundaria, no una sección: llenar el formato de notas de crédito
                 ...
                 el sidebar. Solo aparece si hay un cliente con perfil documental activo:
                 sin eso el botón llevaría a una pantalla vacía. --}}
            @can('ppq.ver')
                @if (\App\Models\ClientePerfilDocumento::where('activo', true)->whereNotNull('formato_export')->exists())
                    <a href="{{ route('ppq.nc-exportaciones.index') }}"
