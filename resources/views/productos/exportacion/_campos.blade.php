<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    <div>
        ...
        <input type="text" name="nombre_en" value="{{ old('nombre_en', $p?->nombre_en) }}" required
               class="mt-1 w-full rounded-md border-gray-300 text-sm" placeholder="ej. Cashew seed baked">
        <p class="mt-1 text-xs text-gray-400">No hace falta escribir «- N units»: la factura de exportación lo agrega sola a partir de las unidades por caja.</p>
...
<div>
    <label class="inline-flex items-center gap-2 text-sm text-gray-700">
        ...
        Activo (disponible al armar listas de empaque nuevas)
    </label>
</div>
