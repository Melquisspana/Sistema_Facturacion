<x-configuracion-layout titulo="Contabilidad">
    {{-- max-w-2xl: dos campos y un aviso no necesitan el ancho completo del módulo.
         El MARCO lo pone el shell; el ancho interno lo decide cada pantalla. --}}
    <form method="POST" action="{{ route('configuracion.contabilidad.update') }}" class="max-w-2xl space-y-6">
        @csrf
        @method('PUT')
