...
class AuditoriaTest extends TestCase
{
    ...
    public function test_administrador_y_contador_pueden_ver(): void
    {
        ...
        $this->actingAs($this->usuario('contabilidad'))->get(route('auditoria.index'))->assertOk();
    }
    ...
    public function test_facturacion_y_consulta_no_pueden_ver(): void
    {
        ...
        $this->actingAs($this->usuario('jefatura'))->get(route('auditoria.index'))->assertForbidden();
    }
}
